  ...
  return (
    ...
    >
      <Modal.Header closeButton className="bg-dark text-white">
        <Modal.Title id="payment-modal-title">Confirm Your Subsription</Modal.Title>
      </Modal.Header>
      <Modal.Body className="bg-dark">
        ...
        <div className="text-end mt-4">
          ...
          <Button variant="secondary" style={{padding:'13px 10px 12px',borderRadius:'0'}} onClick={onClose} className="ms-2">
            Cancel
          </Button>
        </div>
      </Modal.Body>
