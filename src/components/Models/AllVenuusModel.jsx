...
const AllVenuusModel = ({ show, onClose, SetTeamBoxModel,setState }) => {
    ...
    return (
        <Modal show={show} onHide={onClose} size='xl' centered className='py-4 ' >
            <Modal.Header closeButton>
                <Modal.Title>All Venue lists</Modal.Title>
            </Modal.Header>
