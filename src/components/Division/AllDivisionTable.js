    ...
    return (
        <div className='section-main m-3 px-3 py-4 rounded-lg shadow-lg max-w-4xl '>
            ...
            <div style={{ maxHeight: '400px', overflowY: 'auto' }}>
                    ...
                    <Table responsive hover size="sm" className=' mt-2'>
                        ...
                        <tbody>
                            ...
                            {AllDivisionsData?.data?.length > 0 ? AllDivisionsData?.data?.map((item, index) => (
                                ...
                                <td colSpan="7" className='text-center'>No Divisions Available</td>
                            </tr>}
                        </tbody>
                    </Table>}
                ...
                {deleteModel && <DeleteModel show={DeleteModel} onClose={handleCloseModel} OnDelete={handleDeletePerson} title='Division' />}
            </div>
