...
import { Add_Tournaments, GetTournaments, GetTournamentsDetailsByTournamentId, UpdateTournaments } from '../../store/tournament/actions/actionsCreators';
...
const AddTournamentFields = () => {
    ...
    const VenueStatusOptions = VenueData && VenueData?.data?.length > 0
    ...
    return (
        <>
            <h2 className='my-3 fw-bold'>{TournamentEdit ? 'Update Tournament':'Add Tournament'}</h2>
