...
const AllTeamsDetails = () => {
    ...
    return (
        <>
            ...
            {CoManagerBoxModel && <AddCoManagerModel show={CoManagerBoxModel} onClose={() => SetCoManagerBoxModel(false)} SetCoManagerBoxModel={SetCoManagerBoxModel} id={id} setState={setState} />}
            {PlayerBoxModel && <AddPlayerModel show={PlayerBoxModel} onClose={() => SetPlayerBoxModel(false)} SetPlayerBoxModel={SetPlayerBoxModel} id={id} setState={setState} />}
